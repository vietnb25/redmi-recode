...
const Question2: React.FC<Question2Props> = ({ onCorrectAnswer }) => {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const [showResult, setShowResult] = useState(false);

    // Đáp án đúng là C (Cầu vồng hoàng hôn)
        ...
        <GameLayout>
            ...
            <div style={{ padding: '0 28px' }}>
                <h2 style={{
                    ...
                    Bạn yêu thích màu sắc nào nhất của sản phẩm Redmi Note 13 trong lần ra mắt này?
                </h2>

                {/* Answer Options - 2 on top, 1 on bottom */}
                <div style={{ marginBottom: '60px' }}>
                    ...
                    {/* Second Row - Option C (aligned with option A) */}
                    <div style={{
                        display: 'flex',
                        ...
                        <div
                            ...
                            style={{
                                width: '154px',
                                height: '137px',
                                border: selectedAnswer === 'C' ? '1.5px solid #53498D' : '1px solid transparent',
                                borderRadius: '8px',
                                cursor: 'pointer',
                                backgroundColor: '#fff',
                                position: 'relative',
                                boxShadow: selectedAnswer === 'C' ? '0px 0px 5px 0px rgba(111, 100, 164, 0.6)' : 'none',
                                overflow: 'hidden'
                            }}
                        >
                            {/* Image Section */}
